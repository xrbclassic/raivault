...
export class NotificationService {
  ...
  sendLedgerChromeWarning() {
    this.sendWarning(
      ...
      `<a href="https://github.com/xrbclassic/raivault/releases" target="_blank">RaiVault Desktop</a>. ` +
      `&nbsp; <a href="https://github.com/xrbclassic/raivault/issues/69" target="_blank">More Info</a>`,
